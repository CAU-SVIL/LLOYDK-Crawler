...
def new_song_id(driver):
    addresslist=[]
    songid_list=[]
    keyword_list = ["뉴진스","르세라핌", "엔믹스","아이브","있지","에스파","블랙핑크","트와이스","아이들","레드벨벳","케플러","스테이씨","프로미스나인","이달의소녀","우주소녀","마마무", "드림캐쳐", "Weeekly", "Billlie", "VIVIZ", "오마이걸", "브레이브걸스", "퍼플키스", "woo!ah!", "CLASS:y", "로켓펀치"]
